...
contract RunicOracleUpgradeable is PegOracleUpgradeable, UUPSUpgradeable {
    ...
    function initialize(IUniswapV2Pair pair_, address token_, uint256 period_, uint256 startTime_, uint256 startEpoch_) public initializer {
        __RunicOracle_init(pair_, token_, period_, startTime_, startEpoch_);
    }

    function __RunicOracle_init(IUniswapV2Pair pair_, address token_, uint256 period_, uint256 startTime_, uint256 startEpoch_) internal onlyInitializing {
