...
/**
 * @title Quartz
 * Quartz is taxed not due to price of itself but price of the oracle token Runite
 */
contract Quartz is TaxableToken {
    using SafeERC20 for IERC20;

    constructor(uint256 taxRate_, address taxCollectorAddress_) TaxableToken(taxRate_, taxCollectorAddress_) ERC20("QUARTZ", "QUARTZ") {
        ...
        priceFloor = 5e5; // allow for lower price floor
