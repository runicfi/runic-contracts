...
contract FateOracleUpgradeable is PegOracleUpgradeable, UUPSUpgradeable {
    ...
    function initialize(IUniswapV2Pair pair_, address token_, uint256 period_, uint256 startTime_, uint256 startEpoch_) public initializer {
        __FateOracle_init(pair_, token_, period_, startTime_, startEpoch_);
    }

    function __FateOracle_init(IUniswapV2Pair pair_, address token_, uint256 period_, uint256 startTime_, uint256 startEpoch_) internal onlyInitializing {
