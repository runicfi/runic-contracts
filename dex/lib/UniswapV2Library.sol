...
library UniswapV2Library {
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"3e0000e85c1805a5234ec4f46a4cecfd405a9a3c63c869d9509ec3cbf622ddda" // init code hash. keccak256(UniswapV2Pair.bytecode)
                        )
                    )
                )
            )
    ...
    function getAmountOut(uint256 amountIn, uint256 reserveIn, uint256 reserveOut) internal pure returns (uint256 amountOut) {
        ...
        uint256 amountInWithFee = amountIn * 997; // changed from 998
    ...
    function getAmountIn(uint256 amountOut, uint256 reserveIn, uint256 reserveOut) internal pure returns (uint256 amountIn) {
        ...
        uint256 denominator = (reserveOut - amountOut) * 997; // changed from 998
